...
# Upload FASTA: skills-testbed/outputs/protein-localization-signal-import/web_submission/deeploc_2_1_input.fasta
...
# Upload FASTA: skills-testbed/outputs/protein-localization-signal-import/web_submission/signalp_6_0_input.fasta
...
# Upload FASTA: skills-testbed/outputs/protein-localization-signal-import/web_submission/targetp_2_0_input.fasta
