...
# Upload FASTA: skills-testbed/outputs/localization-smoke-test/web_submission/deeploc_2_1_input.fasta
...
# Upload FASTA: skills-testbed/outputs/localization-smoke-test/web_submission/signalp_6_0_input.fasta
...
# Upload FASTA: skills-testbed/outputs/localization-smoke-test/web_submission/targetp_2_0_input.fasta
